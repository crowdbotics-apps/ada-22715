...
admin.site.site_header = "ADA"
admin.site.site_title = "ADA Admin Portal"
admin.site.index_title = "ADA Admin"

# swagger
api_info = openapi.Info(
    title="ADA API",
    default_version="v1",
    description="API documentation for ADA App",
)
